...
事实：本轮继续把 Codex 作为 major_update 观察对象，重点关注 release 中对 goal 工作流、权限 profile、插件、沙箱和 MCP/工具调用体验的迭代。
推断：Codex 的长期价值不只是“写代码更快”，而是把 AI 执行权放进可配置的边界里，让团队能逐步把小任务交给 Agent。
